...
internal class MessageEventHandler(
    ...
    override suspend fun handle(
        ...
        is MessageDeleteBulk -> handle(event, kord, coroutineScope)
        is MessageReactionAdd -> handle(event, kord, coroutineScope)
        is MessageReactionRemove -> handle(event, kord, coroutineScope)
        is MessageReactionRemoveAll -> handle(event, kord, coroutineScope)
        is MessageReactionRemoveEmoji -> handle(event, kord, coroutineScope)
        else -> null
    }
    ...
    private suspend fun handle(
        ...
        return MessageCreateEvent(Message(data, kord), guildId.value, member, coroutineScope = coroutineScope)
    }
    ...
    private suspend fun handle(
        ...
        MessageUpdateEvent(id, channelId, this, old, kord, coroutineScope = coroutineScope)
    }
    ...
    private suspend fun handle(
        ...
        return MessageDeleteEvent(id, channelId, guildId.value, removed, kord, coroutineScope = coroutineScope)
    }
    ...
    private suspend fun handle(
        ...
        with(event.reaction) {
            ...
            return ReactionRemoveEmojiEvent(data, kord, coroutineScope = coroutineScope)
        }
